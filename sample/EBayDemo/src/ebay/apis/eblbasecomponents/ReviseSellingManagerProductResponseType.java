 ...
 * 
 */
@RootElement(name = "ReviseSellingManagerProductResponse", namespace = "urn:ebay:apis:eBLBaseComponents")
public class ReviseSellingManagerProductResponseType extends AbstractResponseType implements Serializable {
